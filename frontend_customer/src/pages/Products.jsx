...
import { 
  ...
  FiPackage, FiTag, FiDollarSign, FiX, FiActivity, FiShoppingCart, FiCheck, FiCreditCard, FiBox, FiHeart 
} from "react-icons/fi"

/* ─── Product Card Component ─── */
function ProductCard({ product, onEdit, onDelete, isInternal }) {
      ...
      <div className="flex flex-col gap-6">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-black/5 dark:border-white/5 pb-4">
          <div>
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mt-1 font-medium">Explore the full collection and find what you need.</p>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-6">
          {loading ? (
            ...
            <div className="col-span-full py-20 text-center bg-white dark:bg-slate-900 rounded-3xl border border-black/5 dark:border-white/5"><FiPackage className="w-16 h-16 text-slate-200 mx-auto mb-4"/><p className="text-lg font-black text-slate-800">No products found</p></div>
          ) : (

...
import { FiUser, FiMail, FiPhone, FiEdit3, FiCheck, FiX, FiInfo, FiCamera, FiLoader, FiLogOut } from "react-icons/fi"
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-box-bg dark:bg-box-dark-bg rounded-2xl border border-black/[.04] dark:border-white/[.06] p-6 text-center shadow-sm">
              ...
              <div className="mt-6 pt-6 border-t border-black/[.04] dark:border-white/[.06]">
                 <button onClick={logout} className="w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-rose-50 text-rose-500 hover:bg-rose-500 hover:text-white dark:bg-rose-500/10 dark:hover:bg-rose-500 font-bold transition-all">
                    <FiLogOut /> Sign Out
                 </button>
              </div>
            </div>

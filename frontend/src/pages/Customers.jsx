    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative z-10 w-full max-w-2xl bg-box-bg dark:bg-box-dark-bg rounded-2xl shadow-2xl border border-black/[.06] dark:border-white/[.08] flex flex-col max-h-[85vh]">
        ...
        <div className="flex-1 overflow-hidden flex flex-col">
           <div className="px-6 py-4 bg-slate-50/50 dark:bg-transparent/20 border-b border-black/[.02] dark:border-white/[.02] flex items-center justify-between">
              <h3 className="text-xs font-bold text-slate-500 dark:text-slate-300 uppercase tracking-widest flex items-center gap-2">
                 <FiShoppingBag className="text-sky-500"/> Order History
              </h3>
           ...
           <div className="flex-1 overflow-y-auto px-6 py-2">
              {loading ? (
                <div className="flex flex-col items-center justify-center py-20 gap-3">
                   ...
                   <p className="text-xs text-slate-400 dark:text-slate-300 font-medium">Loading History...</p>
                </div>
              ) : history.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 gap-3 opacity-40 italic">
                   ...
                   <p className="text-sm text-slate-400 dark:text-slate-300">No orders found for this customer.</p>
                </div>
              ) : (
                   ...
                   {history.map((order, idx) => (
                     <div key={order.id} className="group p-4 rounded-2xl bg-white dark:bg-transparent/[.02] border border-black/[.03] dark:border-white/[.03] hover:border-sky-400/30 transition-all shadow-xs hover:shadow-md">
                        ...
                        <div className="flex items-end justify-between">
                           <div>
                              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-1">Products</p>
                              <p className="text-sm font-black text-slate-800 dark:text-white">{order.total_items} Items</p>
                           </div>
                           <div className="text-right">
                              <p className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-widest mb-1 text-teal-500">Total Price</p>
        ...
        <div className="px-6 py-4 border-t border-black/[.05] dark:border-white/[.06] bg-slate-50/30 dark:bg-transparent/10">
           <button onClick={onClose} className="w-full py-2.5 rounded-xl bg-transparent dark:bg-transparent/5 border border-black/5 dark:border-white/5 text-slate-600 dark:text-slate-300 font-bold text-xs uppercase tracking-widest hover:bg-slate-100 dark:hover:bg-transparent/10 transition-all">Close</button>
        </div>
      </div>
    </div>
  )
